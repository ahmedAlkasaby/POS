            ...
            <ul class="nav nav-tabs" id="custom-tabs-one-tab" role="tablist">
                <li class="nav-item">
                    <a class="nav-link" id="custom-tabs-one-home-tab" data-toggle="pill"
                        ...
                        aria-selected="false">@lang('site.user')</a>
                </li>
                <li class="nav-item">
            ...
            <div class="tab-content" id="custom-tabs-one-tabContent">
                <div class="tab-pane fade" id="custom-tabs-one-home" role="tabpanel"
                    ...
                    <div class="form-check">
                        <input type="checkbox" value="users-read" class="form-check-input" id="exampleCheck1" name="permissions[]" {{ old('permissions[]') == 'users-read' ? 'checked' : '' }}>
                        <label class="form-check-label" for="exampleCheck1">Read User</label>
                    </div>
                    <div class="form-check">
                        <input type="checkbox" value="users-create" class="form-check-input" id="exampleCheck1" name="permissions[]">
                        <label class="form-check-label" for="exampleCheck1">Create User</label>
                    </div>
                    <div class="form-check">
                        <input type="checkbox" value="users-update" class="form-check-input" id="exampleCheck1" name="permissions[]">
                        <label class="form-check-label" for="exampleCheck1">Edit User</label>
                    </div>
                    <div class="form-check">
                        <input type="checkbox" value="users-delete" class="form-check-input" id="exampleCheck1" name="permissions[]">
                ...
                <div class="tab-pane fade" id="custom-tabs-one-profile" role="tabpanel"
                    ...
                    <div class="form-check">
                        <input type="checkbox" value="categories-create" class="form-check-input" id="exampleCheck1" name="permissions[]">
                        <label class="form-check-label" for="exampleCheck1">Create Category</label>
                    </div>
                    <div class="form-check">
                        <input type="checkbox" value="categories-read" class="form-check-input" id="exampleCheck1" name="permissions[]">
                        <label class="form-check-label" for="exampleCheck1">Read Category</label>
                    </div>
                    <div class="form-check">
                        <input type="checkbox" value="categories-update" class="form-check-input" id="exampleCheck1" name="permissions[]">
                        <label class="form-check-label" for="exampleCheck1">Edit Category</label>
                    </div>
                    <div class="form-check">
                        <input type="checkbox" value="categories-delete" class="form-check-input" id="exampleCheck1" name="permissions[]">
                ...
                <div class="tab-pane fade" id="custom-tabs-one-messages" role="tabpanel"
                    ...
                    <div class="form-check">
                        <input type="checkbox" value="products-create" class="form-check-input" id="exampleCheck1" name="permissions[]">
                        <label class="form-check-label" for="exampleCheck1">Create Product</label>
                    </div>
                    <div class="form-check">
                        <input type="checkbox" value="products-read" class="form-check-input" id="exampleCheck1" name="permissions[]">
                        <label class="form-check-label" for="exampleCheck1">Read Product</label>
                    </div>
                    <div class="form-check">
                        <input type="checkbox" value="products-update" class="form-check-input" id="exampleCheck1" name="permissions[]">
                        <label class="form-check-label" for="exampleCheck1">Edit Product</label>
                    </div>
                    <div class="form-check">
                        <input type="checkbox" value="products-delete" class="form-check-input" id="exampleCheck1" name="permissions[]">
                ...
                <div class="tab-pane fade" id="custom-tabs-one-clients" role="tabpanel"
                    ...
                    <div class="form-check">
                        <input type="checkbox" value="clients-create" class="form-check-input" id="exampleCheck1" name="permissions[]">
                        <label class="form-check-label" for="exampleCheck1">Create Client</label>
                    </div>
                    <div class="form-check">
                        <input type="checkbox" value="clients-read" class="form-check-input" id="exampleCheck1" name="permissions[]">
                        <label class="form-check-label" for="exampleCheck1">Read Client</label>
                    </div>
                    <div class="form-check">
                        <input type="checkbox" value="clients-update" class="form-check-input" id="exampleCheck1" name="permissions[]">
                        <label class="form-check-label" for="exampleCheck1">Edit Client</label>
                    </div>
                    <div class="form-check">
                        <input type="checkbox" value="clients-delete" class="form-check-input" id="exampleCheck1" name="permissions[]">
                ...
                <div class="tab-pane fade" id="custom-tabs-one-orders" role="tabpanel"
                    ...
                    <div class="form-check">
                        <input type="checkbox" value="orders-create" class="form-check-input" id="exampleCheck1" name="permissions[]">
                        <label class="form-check-label" for="exampleCheck1">Create Order</label>
                    </div>
                    <div class="form-check">
                        <input type="checkbox" value="orders-read" class="form-check-input" id="exampleCheck1" name="permissions[]">
                        <label class="form-check-label" for="exampleCheck1">Read Order</label>
                    </div>
                    <div class="form-check">
                        <input type="checkbox" value="orders-update" class="form-check-input" id="exampleCheck1" name="permissions[]">
                        <label class="form-check-label" for="exampleCheck1">Edit Order</label>
                    </div>
                    <div class="form-check">
                        <input type="checkbox" value="orders-delete" class="form-check-input" id="exampleCheck1" name="permissions[]">
